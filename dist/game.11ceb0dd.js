...
var GuessNumber = function () {
    function GuessNumber(answerGenerator) {
        _classCallCheck(this, GuessNumber);

        this.answer = answerGenerator.generateRandomNumber();
        this.timess = 0;
    }

    _createClass(GuessNumber, [{
        key: 'test',
        value: function test(input) {
            ...
            var userInput = this.formatInput(input.split(" ").map(function (ele) {
                return +ele;
            }));
            if (userInput == false) {
            ...
            var result = a + 'A' + (b - a) + 'B';
            return result;
        }
    }, {
        key: 'formatInput',
        value: function formatInput(collection) {
            var flag = true;
...
},{}],"answer-generator.js":[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var AnswerGenerator = function () {
    function AnswerGenerator(min, max, length) {
        _classCallCheck(this, AnswerGenerator);
    ...
    _createClass(AnswerGenerator, [{
        key: "generateRandomNumber",
        value: function generateRandomNumber() {
            var sequence = [];
            while (sequence.length < this.length) {
                var randomNumber = ~~(Math.random() * (this.max - this.min + 1)) + this.min;
...
var game = new GuessNumberGame(new AnswerGenerator(0, 9, 4));

$('#submit-answer').click(function () {
    var input = $('#input-field').val();
    var result = game.test(input);
...
},{"./guess-number-game":"guess-number-game.js","./answer-generator":"answer-generator.js"}],"../../.npm/_npx/56285/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.npm/_npx/56285/lib/node_modules/parcel/src/builtins/hmr-runtime.js","game.js"], null)
//# sourceMappingURL=/game.11ceb0dd.map